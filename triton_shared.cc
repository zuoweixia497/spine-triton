    ...
    ->def("create_annotation",
      ...
      .def("create_descriptor_load",
        [](TritonOpBuilder &self, Value &base, std::vector<Value> &offsets,
            std::vector<int32_t> &shape, std::vector<int32_t> &micro_size) -> Value {
          return self.create<xsmt::DescriptorLoadOp>(base, offsets, shape, micro_size);
        })
      ...
      .def("create_view",
        [](TritonOpBuilder &self, Value &base, std::vector<Value> &offsets, std::vector<int32_t> &shape,
      ...
      .def("create_mmt4d", [](TritonOpBuilder &self, Value &a, Value &b, Value &c) -> Value{
...
void init_triton_spine_triton(py::module &&m) {
    ...
    m.def("load_dialects", [](mlir::MLIRContext &context) {
      ...
      registry.insert<mlir::xsmt::XSMTDialect>();
